...
<body class="main-bg">
  <section class="sec-form">
    ...
    <form action="../php/editar_usuario.php" id="formulario" name="formulario" class="form" method="POST">
      ...
      <div class="submit">
        <input class="submitContent btn btn-primary" type="submit" value="Atualizar" />
      </div>
    </form>
  </section>
</body>
